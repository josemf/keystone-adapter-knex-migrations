...
class MigrationExecution {
    ...
    constructor(listAdapters, knex, options = { cacheSchemaTableName: "InternalSchema", provider: "postgres", mode: "migrate", ignoreCacheSchema: false, silent: false, schemaName: undefined }) {
    ...
    */
    ...
    _knexCapture(callback) {
        ...
        this._sqlQueries.push(knexQuery.toString() + ";\n");
        ...
        if(this._options.mode === "ask") {
            ...
            this._log.sql("  " + knexQuery.toString());
            this._log.newLine();
