...
class MigrationBuilder {
    ...
    _areObjectsEqualRecursive(object1, object2) {
        ...
        if(Object.keys(object1).filter(k => typeof object1[k] !== "undefined").length
           !== Object.keys(object2).filter(k => typeof object1[k] !== "undefined").length) {
            return false;
        }
...
`);
    ...
    _updateAssociation(name, list, options, field, before) {
        this._migration("association", "update", name, { list, options, field, before });
    }
