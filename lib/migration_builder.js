                ...
                renameField.forEach(fieldSchema => {
                    ...
                    if(fieldSchema.target.type === "Relationship") {
                        ...
                        this._renameAssociation(fieldSchema.source.name, listSchema.list, { }, fieldSchema.target, fieldSchema.source,
                                                fieldSchema.options.target, fieldSchema.options.left, fieldSchema.options.right);
                    } else {
...
`);
    ...
    _renameAssociation(name, tableName, options, field, before, target, left, right) {
        this._migration("association", "rename", tableName, {
            options, field, before, cardinality: field.options.cardinality,
            target, left, right
        });        
    }
